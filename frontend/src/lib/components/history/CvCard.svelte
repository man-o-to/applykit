...
<button
  onclick={onSelect}
  class="w-full rounded-xl border p-3.5 text-left outline-none transition-all
    {selected ? 'scale-[1.01] border-primary/50 bg-primary/5 shadow-md ring-1 ring-primary/20' : 'border-border/60 bg-card hover:border-border hover:bg-accent/50 hover:shadow-sm'}
  "
>
